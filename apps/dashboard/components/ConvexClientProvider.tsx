...
/** Use in components that call useQuery: skip Convex when URL is not set and show a placeholder instead. */
export const ConvexAvailableContext = createContext(!!convex);
